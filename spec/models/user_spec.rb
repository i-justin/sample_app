...
describe User do
   ...
   describe "password validations" do
		...
		it "should reject short passwords" do
			short="a"*5
			u_short_pw=User.new(@attr.merge(:password=>short, :password_confirmation=>short))
			u_short_pw.should_not be_valid
		end
		
		it "should reject long passwords" do
			long="a"*41
			u_long_pw=User.new(@attr.merge(:password=>long, :password_confirmation=>long))
			u_long_pw.should_not be_valid
   ...
   describe 'micropost associations' do
   	...
   	it "should have micrposts attributes" do
