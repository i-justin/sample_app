...
describe UsersController do
   	...
   	describe "for non signed-in users" do
		...
		describe "for signed-in users" do
			before(:each) do
				...
				@third=Factory(:user, :email=>"user3@example.net")
   ...
   describe "GET 'show'" do
      ...
      it "should show the user's microposts'" do
      	...
      	mp2=Factory(:micropost, :user=>@user, :content=>"foobar test")
      ...
      it "shoud paginate microposts" do
  ...
  describe "PUT 'update'" do
	...
	describe "authentication of edit/update actions" do
      ...
      describe "for signed in users" do
         before(:each) do
         	wrong_user=Factory(:user, :email=>"wrong_email@example.net")
  ...
  describe "DELETE 'destroy' " do
	   ...
	   describe "as a non-signed in user " do	  	
	  	...
	  	describe "as admin user" do
	  		...
	  		it "should destroy the users" do
	  			lambda do
	  				delete :destroy, :id=>@user
	  		   end.should change(User, :count).by(-1)
	  		end
	  		...
	  		it "should prevent the user from deleting themselves" do
	  			lambda do
